...
const intitalState = {
  ...
  shiftGroups: [
    {
      ...
      shifts: [
        ...
        {id: 2, roleId: 2, start:"2016-12-14T00:00", end:"2016-12-23T00:00"}
      ]
    }
  ],
  shifts:[
  ...
  roles: [
    { id: 1, name: "JS Lead", duration: 2, timeUnit: "week" },
    { id: 2, name: "Ruby Lead", duration: 2, timeUnit: "week" },
    { id: 3, name: "JS Assistant", duration: 3, timeUnit: "week" }
  ]
}
